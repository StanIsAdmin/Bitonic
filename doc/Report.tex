...
\section{Limitations and performances}
  ...
  The biggest limitation of the project is due to the inter-node communication protocol that has been implemented. For reminder, the \textit{master node} oversees the important steps of the communications (See \ref{X} for further information). % TODO place proper reference depending on the modification bring by Stan
